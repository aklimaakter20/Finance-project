    ...
    <section className="py-32">
      <div className="container mx-auto">
        <div className="flex flex-col-reverse sm:flex-row gap-10 lg:gap-2.5 xl:gap-8 justify-between items-center">
          <div className="font-bold leading-tight text-2xl lg:text-3xl">
            <h2>Wern Debit Card</h2>
            <p className="text-secondary font-normal text-sm lg:text-base w-full max-w-[420px] py-3 sm:py-6">
          ...
          <img className="w-1/2 sm:w-2/5" src={DebitCardImg} alt="" />
        </div>
      </div>
    </section>
  );
